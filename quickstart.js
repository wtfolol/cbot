...
var TOKEN_DIR = (process.env.HOME || process.env.HOMEPATH || process.env.USERPROFILE) + '/desktop/cbot/';
...
function appendData(auth) {
  ...
  sheets.spreadsheets.values.append({
	  auth: auth,
    spreadsheetId: '15M6lPILyUsc4o26ZtnTY6HvJM5aBix4VqR76fh1ftXU',
    range: 'Sheet1!A5:B5', //Change Sheet1 if your worksheet's name is something else
